...
score=98.3444
# 1、第一种格式化输出
print(str(age)+"年龄的"+name)
print(age,"年龄的",name)
print("考了%.2f成绩的%d年龄的%.5s"%(score,age,name))

# 2、格式化输出 format:{}中的索引引用后续的参数
print("考了{}成绩的{}年龄的{}".format(score,age,name))
print("考了{0}成绩的{1}年龄的{1}".format(score,age,name))
# {}不指定时按照顺序取值
# {}指定时按照顺序取值
